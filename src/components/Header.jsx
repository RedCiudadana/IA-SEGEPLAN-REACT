...
function Header({ onToggleSidebar }) {
  const [theme, setTheme] = useState(localStorage.getItem('fluxi-theme') || (window.matchMedia('(prefers-color-scheme: dark)').matches ? 'dark' : 'light'));
  ...
  // Función para alternar entre dark/light
  const toggleTheme = () => {
            ...
            <div className="header-inner-one">
              ...
              <div className="left-logo-area">
                ...
                <button
                  ...
                  id="collups-left"
                  onClick={onToggleSidebar} // ✅ Llama a la función para alternar el Sidebar
                >
              ...
              <div className="header-right">
                ...
                <div className="action-interactive-area__header">
                  ...
                  <div className="single_action__haeader search-action openuptip" flow="down" tooltip="Search">
                    ...
                    <div className="search-opoup slide-down__click">
                  ...
                  <div className="single_action__haeader notification openuptip" flow="down" tooltip="Notification">
                    ...
                    <div className="notification_main_wrapper slide-down__click">
                      <h3 className="title">
                  ...
                  {/* Botón para alternar entre Light/Dark */}
                  <div
