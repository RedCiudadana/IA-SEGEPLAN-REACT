...
function Prototipo5() {
  ...
  useEffect(() => {
    const savedHistory = JSON.parse(localStorage.getItem('chatHistory5')) || [];
    setChatHistory(savedHistory);
  }, []);

  // Guardar historial en localStorage cada vez que cambie
  useEffect(() => {
    localStorage.setItem('chatHistory5', JSON.stringify(chatHistory));
  }, [chatHistory]);
    ...
    <>
      ...
      <div className="main-center-content-m-left-2 center-content search-sticky">
        {isVisible && (
          ...
          🌟 <b>¡Bienvenido al módulo de Análisis de Prospección!</b> 🌟
              <br/>
              Este asistente permite realizar <b>análisis de prospectiva estratégica</b>, evaluando escenarios futuros y proyecciones en planificación pública.
              <br/><br/>
              📌 <b>¿Cómo funciona?</b>
              <br/>1️⃣ Selecciona el tema de análisis prospectivo (ej. cambio climático, crecimiento urbano, inversión pública).
              <br/>2️⃣ Carga información relevante en PDF, Word o Excel.
              <br/>3️⃣ El asistente genera escenarios posibles y tendencias futuras.
              <br/>4️⃣ Proporciona recomendaciones para mitigar riesgos y aprovechar oportunidades.
              <br/>5️⃣ Descarga el informe con visualizaciones y modelos predictivos.
              <br/>
              <br/>
