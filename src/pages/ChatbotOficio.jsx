...
function ChatbotOficio() {
  ...
  *"Redacta una carta formal en nombre de SEGEPLAN dirigida al rector de una universidad, solicitando cooperación técnica en planificación territorial. La carta debe incluir:
  Saludo formal y presentación de SEGEPLAN como entidad rectora de la planificación en Guatemala.
  Contexto de la solicitud, explicando la necesidad de fortalecer capacidades técnicas en desarrollo territorial.
  Propuesta de colaboración, mencionando el intercambio de información, asistencia técnica y posibles convenios.
  Cierre formal con una invitación a una reunión para discutir detalles y firmar un acuerdo. La carta debe tener un tono formal, institucional y ser clara en sus intenciones."*`,
  ...
  *"Genera un memorando interno para todos los funcionarios de SEGEPLAN informando sobre el cambio en procedimientos administrativos.
  Debe incluir:
  Encabezado oficial con fecha, destinatario y asunto.
  Introducción breve explicando la razón del cambio.
  Descripción de los nuevos procedimientos, detallando qué cambia, desde cuándo aplica y qué se espera del personal.
  Indicaciones adicionales, como dónde encontrar más información o a quién dirigirse para dudas.
  Cierre con un tono profesional y llamado a la acción para asegurar que todos los funcionarios cumplan con las nuevas directrices."*`,
  ...
  *"Escribe un informe ejecutivo sobre los avances del proyecto de planificación urbana que SEGEPLAN está ejecutando con financiamiento de cooperación internacional.
  ...
  Resumen ejecutivo (1 párrafo) con los avances generales del proyecto.
  Objetivos del proyecto y su estado actual.
  Logros alcanzados hasta la fecha, incluyendo cifras y datos relevantes.
  Desafíos y riesgos identificados, junto con estrategias para mitigarlos.
  Próximos pasos y acciones previstas para los próximos tres meses. Debe mantener un tono técnico, claro y enfocado en resultados medibles."*`,
  ...
  *"Redacta una solicitud de presupuesto dirigida al departamento financiero de SEGEPLAN para la organización del evento “Transformación Digital en la Administración Pública”.
  Debe incluir:
  Introducción explicando la relevancia del evento para la modernización institucional.
  Detalle de los gastos estimados, incluyendo alquiler de espacio, materiales, honorarios de expertos, entre otros.
  Justificación del presupuesto, resaltando el impacto y beneficios esperados.
  Solicitud de aprobación y pasos siguientes en el proceso administrativo. Debe mantener un tono formal y estructurado, con cifras estimadas y referencias a lineamientos institucionales."*`,
  ...
  *"Escribe una respuesta oficial a una consulta ciudadana recibida en SEGEPLAN sobre proyectos de planificación territorial en un municipio específico.
  Debe incluir:
  Saludo formal y agradecimiento por la consulta.
  Explicación del marco general de planificación territorial y el rol de SEGEPLAN en este proceso.
  Información sobre proyectos activos en el municipio, mencionando objetivos, estado de avance y fuentes de financiamiento.
  Referencias a documentos oficiales o enlaces donde el ciudadano pueda obtener más información.
  Cierre cordial, ofreciendo contacto adicional para resolver más dudas. Debe mantener un tono accesible pero formal, asegurando que la información sea clara y comprensible para el ciudadano."*`
      ]
    }
  ];
              ...
              {history.messages.map((message, msgIndex) => {
                ...
                return (
                  <div className="single-history" key={msgIndex}>
                    ...
                    <button onClick={() => toggleExpand(msgIndex)}>
