...
function Prototipo3() {
  ...
  useEffect(() => {
    const savedHistory = JSON.parse(localStorage.getItem('chatHistory3')) || [];
    setChatHistory(savedHistory);
  }, []);

  // Guardar historial en localStorage cada vez que cambie
  useEffect(() => {
    localStorage.setItem('chatHistory3', JSON.stringify(chatHistory));
  }, [chatHistory]);
    ...
    <>
      ...
      <div className="main-center-content-m-left-2 center-content search-sticky">
        {isVisible && (
          ...
          🌟 <b>¡Bienvenido al módulo de Análisis de Políticas Públicas!</b> 🌟
              <br/>
              Este asistente facilita el <b>análisis de políticas públicas</b>, identificando fortalezas, áreas de mejora y comparaciones con modelos internacionales.
              <br/><br/>
              📌 <b>¿Cómo funciona?</b>
